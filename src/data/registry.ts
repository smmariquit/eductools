...
export const visualizerModules: VisualizerModule[] = [
  ...
  { id: 'forces-motion', title: 'Forces and Motion', description: 'Simulate Newton\'s Second Law of Motion (F = ma).', path: '/visualizer/forces-and-motion', tags: ['Grade 8', 'Physics', 'MATATAG Aligned'] },
  ...
  { id: 'em-spectrum', title: 'Electromagnetic Spectrum', description: 'Explore the relationship between wavelength, frequency, and energy.', path: '/visualizer/electromagnetic-spectrum', tags: ['Grade 10', 'Physics', 'MATATAG Aligned'] },
  ...
  { id: 'computer-science', title: 'Digital Logic: Bits to Pixels', description: 'Interact with bits to see how raw binary voltage creates physical RGB pixels on a screen.', path: '/visualizer/computer-science', tags: ['Computer Science', 'Physics', 'Grade 8', 'Grade 9', 'Grade 10'] }
];
