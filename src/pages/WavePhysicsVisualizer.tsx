...
const WavePhysicsVisualizer = () => {
  ...
  return (
    <VisualizerLayout
      ...
      educationalContent={
        <>
          <h2>Physics: Grade 10 Science</h2>
          <p>A wave is a disturbance that transfers energy through matter or space. Understanding wave mechanics is highly relevant in the Philippines.</p>
          <h3>Local Applications</h3>
          <ul>
            <li><strong>Ocean Waves:</strong> Mechanical waves generated by wind. The famous "Cloud 9" in Siargao is known worldwide for its massive amplitude transverse waves perfect for surfing.</li>
            <li><strong>Seismic Waves:</strong> Because the Philippines is in the Pacific Ring of Fire, earthquakes generate powerful mechanical waves (P-waves and S-waves) that travel through the Earth's crust.</li>
          </ul>
        </>
      }
    >
