  ...
  return (
    <div className="w-full">
      ...
      <div className="py-8 border-b border-base-300 mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <div className="flex items-center gap-3">
            <CrayonArt name="rocket" size={52} animate="wiggle" className="hidden sm:inline-block shrink-0" />
      ...
      <article className="prose lg:prose-xl mt-16 pt-8 border-t border-base-300 max-w-none text-base-content">
        ...
        <p>
          DepEd's{' '}
          <a href="https://www.deped.gov.ph/matatag/" target="_blank" rel="noopener noreferrer">MATATAG curriculum</a>{' '}
          ...
          <a href="https://lawphil.net/statutes/repacts/ra2013/ra_10533_2013.html" target="_blank" rel="noopener noreferrer">K-12 reform</a>{' '}
        ...
        <p>
          ...
          <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC4060654/" target="_blank" rel="noopener noreferrer">2014 meta-analysis of 225 STEM studies</a>,
          ...
          <a href="https://phet.colorado.edu/en/research" target="_blank" rel="noopener noreferrer">PhET at the University of Colorado Boulder</a>{' '}
