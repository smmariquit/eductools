...
const PhotosynthesisVisualizer = () => {
  ...
  return (
    <VisualizerLayout
      ...
      educationalContent={
        <>
          <h2>Photosynthesis & The Source of Plant Mass (Grades 7-10)</h2>
          <p>Where does the solid wood of a huge tree come from? It is a common misconception that plants "eat" soil. In reality, plant mass comes from invisible Carbon Dioxide gas in the air!</p>
          
          <h3>Key Biochemical Concepts</h3>
          <ul>
            <li><strong>Van Helmont's Experiment:</strong> Proved that soil mass does not change as a plant grows. Plants build their structure (cellulose) by fixing atmospheric carbon.</li>
            <li><strong>Stomatal Gas Exchange:</strong> Guard cells on the leaf open and close to regulate the intake of CO₂ and the release of O₂ and water vapor.</li>
            <li><strong>Law of Limiting Factors:</strong> The rate of photosynthesis is limited by the most scarce resource. If water is 0%, guard cells lose turgor pressure, stomata close, and the rate drops to zero regardless of sunlight.</li>
          </ul>

          <div className="bg-base-200 p-4 rounded-lg mt-4">
            <h4 className="font-bold mb-2 text-sm">Molecular Color Legend (CPK Standard)</h4>
            <div className="flex gap-4 text-xs font-mono">
              <span className="flex items-center gap-1"><span className="w-3 h-3 rounded-full bg-[#EF4444] inline-block"></span> Oxygen (O₂)</span>
              <span className="flex items-center gap-1"><span className="w-3 h-3 rounded-full bg-[#9CA3AF] inline-block"></span> Carbon Dioxide (CO₂)</span>
            </div>
          </div>
        </>
      }
