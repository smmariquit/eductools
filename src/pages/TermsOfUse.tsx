...
const TermsOfUse = () => {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <Helmet>
        <title>Terms of Use | EduVisualsPH</title>
        <meta name="description" content="Terms of Use for EduVisualsPH." />
      </Helmet>
      ...
      <div className="prose prose-base md:prose-lg max-w-none prose-headings:text-base-content prose-p:text-base-content/80 prose-li:text-base-content/80">
        ...
        <p>
          By accessing and using EduVisualsPH ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. 
          If you do not agree to abide by these terms, please do not use this Service.
        </p>

        <h2>2. Educational Purpose</h2>
        <p>
          EduVisualsPH is an interactive educational platform designed to supplement formal instruction. 
        ...
        <p>
          You agree to use EduVisualsPH only for lawful purposes. You may not use the Service to:
        </p>
        <ul>
        ...
        <p>
          All content, visualizers, algorithms, and deep dive documentation created for EduVisualsPH are the intellectual property of the developers, 
        ...
        <p>
          The Service is provided on an "AS IS" and "AS AVAILABLE" basis. EduVisualsPH makes no representations or warranties of any kind, 
