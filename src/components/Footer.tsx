  ...
  return (
    <footer className="footer p-10 bg-base-200 text-base-content border-t border-base-300 mt-16">
      <div className="max-w-[1600px] mx-auto w-full grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        {/* Company Section */}
        <nav>
          <header className="text-[color:var(--ink)] opacity-100 font-bold mb-4 uppercase tracking-wider text-sm">Company</header>
        ...
        {/* Legal Section */}
        <nav>
          <header className="text-[color:var(--ink)] opacity-100 font-bold mb-4 uppercase tracking-wider text-sm">Legal</header>
          <div className="flex flex-col gap-3 text-sm">
      ...
      <div className="max-w-[1600px] mx-auto w-full mt-12 pt-8 border-t border-base-content/10 text-xs text-[color:var(--muted-ink)] leading-relaxed text-center md:text-left">
