...
const CookieConsent = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full z-50 p-4 sm:p-6 pointer-events-none flex justify-center">
      <div className="bg-base-100 shadow-2xl border border-base-300 p-6 rounded-2xl max-w-4xl w-full pointer-events-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        <div className="flex gap-4 items-start md:items-center">
          ...
          <div className="text-sm text-base-content/80 leading-relaxed">
            ...
            <Link to="/privacy" className="font-semibold underline text-[color:var(--link)] hover:text-[color:var(--link-hover)]">
              Privacy Policy
            </Link>
          </div>
        </div>
